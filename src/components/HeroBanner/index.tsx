...
export  const HeroBanner = () => {
    return (
        <section className='relative'>
            <div className=' py-14  '>
                <div className='absolute lg:ml-5 ml-0 -bottom-12 -top-20 left-0 lg:right-1/4 right-0 bg-gradient-to-br from-sky-50 to-blue-200 lg:rounded-b-3xl rounded-none'>
                </div>
